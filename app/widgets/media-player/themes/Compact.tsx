...
export default function CompactTheme(props: MediaThemeProps) {
  const { track, artist, art, palette, accent, progressPercent, showAlbumArt, showProgressBar, showPrimary, showSecondary, textAlignCls } = props;
  const bgColor = palette.DarkMuted;
  const textColor = '#ffffff';
  return (
    <div className="compact-theme flex items-center gap-3 px-3 py-2 rounded-full border shadow-lg bg-zinc-900 text-white border-white/10" style={{ background: bgColor, color: textColor }}>
