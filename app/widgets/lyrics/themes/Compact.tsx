...
export default function CompactTheme(props: LyricsThemeProps) {
  ...
  return (
    <div className="compact-theme px-5 py-3 rounded-full border shadow-lg bg-zinc-900 text-white border-white/10" style={{ background: bgColor }}>
